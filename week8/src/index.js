...
import homeRouter from "../routes/home"; //home화면에서 동작
import updateRouter from "../routes/update"; //(수정하는 주소)update화면에서 동작 
...
app.use('/update', updateRouter); // '/' 뒤에 update 입력하면 updateRouter에 해당하는 화면이 나온다. 
